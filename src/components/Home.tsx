...
export const Home: React.FC<HomeProps> = ({ 
  ...
  // Lógica de Saldo Abatido conforme Pago
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-5 px-1 pt-2">
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center justify-center space-x-2 mt-2">
            <p className="text-[9px] font-black text-neutral-500 uppercase tracking-[0.2em]">{formattedDate}</p>
            ...
            <div className="flex items-center space-x-1.5">
              ...
              <p className="text-[9px] font-black text-neutral-600 dark:text-neutral-400 uppercase tracking-widest tabular-nums">{formattedTime}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="relative z-10 space-y-6 md:space-y-8 text-center md:text-left">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
               ...
               <span className="text-[9px] font-black text-neutral-500 uppercase tracking-[0.3em]">Saldo Real (Líquido)</span>
            </div>
          </div>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-5">
            <div className="space-y-1">
              <p className="text-neutral-400 text-[10px] font-black uppercase tracking-[0.2em]">Fluxo Disponível Hoje</p>
              <div className="flex items-baseline justify-center md:justify-start space-x-2">
                <span className="text-xl font-black text-primary italic">R$</span>
                <h3 className="text-5xl md:text-7xl font-display font-black text-white tracking-tighter italic tabular-nums">
            ...
            >
              ...
              <span className="text-[10px] font-black text-white uppercase tracking-widest italic">Ver Extrato</span>
            </button>
          </div>
        </div>
      </div>
